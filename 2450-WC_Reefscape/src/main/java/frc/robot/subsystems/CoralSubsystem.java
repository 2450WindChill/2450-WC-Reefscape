...
public class CoralSubsystem extends SubsystemBase {
    public TalonFX elevatorMotor = new TalonFX(2);
    public TalonFX endeffectorMotor = new TalonFX(3);
    public PIDController elevatorPidController = new PIDController(0.02, .001, 0);
